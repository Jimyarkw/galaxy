...
const AG_DOMAIN = process.env.AG_DOMAIN || '';          // 固定隧道域名,留空即启用临时隧道
const AG_AUTH = process.env.AG_AUTH || '';              // 固定隧道密钥json或token,留空即启用临时隧道,json获取地址：https://fscarmen.cloudflare.now.cc
